...
<div class="container" id="remote">
	<div class="row user-list">
    	<div class="col-sm-4 user">
			...
			<h3>爬虫名称: </h3><input class="form-control" type="text" name="url" placeholder="输入名称" />
			<h3>过滤字符: </h3><input class="form-control" type="text" name="filter" value="***" />
			</input><button type="submit" value="提交" class="btn pull-right btn-primary">提交</button></form>
		</div>
		<div class="col-sm-8 user">
			<h3>过滤后：</h3>
			<span class="hide_p"><p><?php echo $ftext2; ?></p></span>
		</div>
	</div>
</div>
</body>
